...
ZDIC_FIXTURES_BY_SCENARIO["S38"] = {
    "probe_words": ("出圈", "耙耙柑", "琵琶骨"),
    "rows": (
        *ZDIC_FIXTURES_BY_SCENARIO["S37"]["rows"],
...
ZDIC_FIXTURES_BY_SCENARIO["S42"] = {
    "probe_words": ("老登", "中登", "小登"),
    "rows": (
        {"kind": "char", "entry": "老", "status": "found", "pinyins": ["lǎo"]},
        {"kind": "char", "entry": "中", "status": "found", "pinyins": ["zhōng"]},
        {"kind": "char", "entry": "小", "status": "found", "pinyins": ["xiǎo"]},
        {"kind": "char", "entry": "登", "status": "found", "pinyins": ["dēng"]},
        {"kind": "entry", "entry": "老登", "status": "absent", "pinyins": []},
        {"kind": "entry", "entry": "中登", "status": "absent", "pinyins": []},
        {"kind": "entry", "entry": "小登", "status": "absent", "pinyins": []},
    ),
}

ZDIC_FIXTURES_BY_SCENARIO["S43"] = {
    "probe_words": ("钉选",),
    "rows": (
        {"kind": "char", "entry": "钉", "status": "found", "pinyins": ["dīng", "dìng"]},
        {"kind": "char", "entry": "选", "status": "found", "pinyins": ["xuǎn"]},
        {"kind": "entry", "entry": "钉选", "status": "found", "pinyins": ["dīng", "xuǎn"]},
    ),
}

ZDIC_FIXTURES_BY_SCENARIO["S44"] = {
    "probe_words": ("载具", "在距"),
    "rows": (
        {"kind": "char", "entry": "载", "status": "found", "pinyins": ["zǎi", "zài"]},
        {"kind": "char", "entry": "具", "status": "found", "pinyins": ["jù"]},
        {"kind": "char", "entry": "在", "status": "found", "pinyins": ["zài"]},
        {"kind": "char", "entry": "距", "status": "found", "pinyins": ["jù"]},
        {"kind": "entry", "entry": "载具", "status": "found", "pinyins": ["zài", "jù"]},
        {"kind": "entry", "entry": "在距", "status": "found", "pinyins": ["zài", "jù"]},
    ),
}
...
ZDIC_FIXTURES_BY_SCENARIO["S46"] = {
    "probe_words": ("哲思", "这厮"),
    "rows": (
        {"kind": "char", "entry": "哲", "status": "found", "pinyins": ["zhé"]},
        {"kind": "char", "entry": "思", "status": "found", "pinyins": ["sī"]},
        {"kind": "char", "entry": "这", "status": "found", "pinyins": ["zhè"]},
        {"kind": "char", "entry": "厮", "status": "found", "pinyins": ["sī"]},
        {"kind": "entry", "entry": "哲思", "status": "found", "pinyins": ["zhé", "sī"]},
        {"kind": "entry", "entry": "这厮", "status": "found", "pinyins": ["zhè", "sī"]},
    ),
}
...
ZDIC_FIXTURES_BY_SCENARIO["S48"] = {
    "probe_words": ("单份", "蛋粉"),
    "rows": (
        {"kind": "char", "entry": "单", "status": "found", "pinyins": ["dān", "shàn", "chán"]},
        {"kind": "char", "entry": "份", "status": "found", "pinyins": ["fèn"]},
        {"kind": "char", "entry": "蛋", "status": "found", "pinyins": ["dàn"]},
        {"kind": "char", "entry": "粉", "status": "found", "pinyins": ["fěn"]},
        {"kind": "entry", "entry": "单份", "status": "found", "pinyins": ["dān", "fèn"]},
        {"kind": "entry", "entry": "蛋粉", "status": "found", "pinyins": ["dàn", "fěn"]},
    ),
}
...
ZDIC_FIXTURES_BY_SCENARIO["S51"] = {
    "probe_words": ("哪里", "那算了"),
    "rows": (
        {"kind": "char", "entry": "哪", "status": "found", "pinyins": ["nǎ", "něi"]},
        {"kind": "char", "entry": "里", "status": "found", "pinyins": ["lǐ"]},
        {"kind": "char", "entry": "那", "status": "found", "pinyins": ["nà", "nǎ", "nèi", "nā"]},
        {"kind": "char", "entry": "算", "status": "found", "pinyins": ["suàn"]},
        {"kind": "char", "entry": "了", "status": "found", "pinyins": ["le", "liǎo"]},
        {"kind": "entry", "entry": "哪里", "status": "found", "pinyins": ["nǎ", "lǐ"]},
        {"kind": "entry", "entry": "那算了", "status": "found", "pinyins": ["nà", "suàn", "le"]},
    ),
}

ZDIC_FIXTURES_BY_SCENARIO["S52"] = {
    "probe_words": ("细品",),
    "rows": (
        {"kind": "char", "entry": "细", "status": "found", "pinyins": ["xì"]},
        {"kind": "char", "entry": "品", "status": "found", "pinyins": ["pǐn"]},
        {"kind": "entry", "entry": "细品", "status": "found", "pinyins": ["xì", "pǐn"]},
    ),
}
...
ZDIC_FIXTURES_BY_SCENARIO["S55"] = {
    "probe_words": ("鎗", "一"),
    "rows": (
        {"kind": "char", "entry": "鎗", "status": "found", "pinyins": ["qiāng", "chēng"]},
        {"kind": "char", "entry": "一", "status": "found", "pinyins": ["yī", "héng"]},
        {"kind": "entry", "entry": "鎗", "status": "absent", "pinyins": []},
        {"kind": "entry", "entry": "一", "status": "absent", "pinyins": []},
    ),
}

ZDIC_FIXTURES_BY_SCENARIO["S56"] = {
    "probe_words": ("鎗", "强", "戕", "发布会", "重病号"),
    "rows": (
        {"kind": "char", "entry": "鎗", "status": "found", "pinyins": ["qiāng", "chēng"]},
        {"kind": "char", "entry": "强", "status": "found", "pinyins": ["qiáng", "qiǎng", "jiàng"]},
        {"kind": "char", "entry": "戕", "status": "found", "pinyins": ["qiāng"]},
        {"kind": "entry", "entry": "鎗", "status": "absent", "pinyins": []},
        {"kind": "entry", "entry": "强", "status": "absent", "pinyins": []},
        {"kind": "entry", "entry": "戕", "status": "absent", "pinyins": []},
        *(
            row for row in ZDIC_FIXTURES_BY_SCENARIO["S35"]["rows"]
            if row["entry"] in {"发", "布", "会", "重", "病", "号", "发布会", "重病号"}
        ),
    ),
}

ZDIC_FIXTURES_BY_SCENARIO["S57"] = {
    "probe_words": ("嘢", "咽", "春暖花开"),
    "rows": (
        {"kind": "char", "entry": "嘢", "status": "found", "pinyins": ["yě"]},
        {"kind": "char", "entry": "咽", "status": "found", "pinyins": ["yān", "yàn", "yè"]},
        {"kind": "entry", "entry": "嘢", "status": "absent", "pinyins": []},
        {"kind": "entry", "entry": "咽", "status": "absent", "pinyins": [], "expected_selected_pinyins": ["yàn"]},
        {"kind": "char", "entry": "春", "status": "found", "pinyins": ["chūn"]},
        {"kind": "char", "entry": "暖", "status": "found", "pinyins": ["nuǎn"]},
        {"kind": "char", "entry": "花", "status": "found", "pinyins": ["huā"]},
        {"kind": "char", "entry": "开", "status": "found", "pinyins": ["kāi"]},
        {"kind": "entry", "entry": "春暖花开", "status": "found", "pinyins": ["chūn", "nuǎn", "huā", "kāi"]},
    ),
}
